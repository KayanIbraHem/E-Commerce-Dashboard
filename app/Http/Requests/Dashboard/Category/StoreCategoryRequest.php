...
class StoreCategoryRequest extends FormRequestBase
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "id_category" => ['required', new UniquePerOrganizationRule($organizationId, 'categories', __('message.id_category_column'))],
