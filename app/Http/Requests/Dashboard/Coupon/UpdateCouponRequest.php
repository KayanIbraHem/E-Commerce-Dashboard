...
class UpdateCouponRequest extends FormRequestBase
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            "code" => ["required", new UniquePerOrganizationRule($organizationId, 'coupons', __('message.code_column'), $this->coupon)],
