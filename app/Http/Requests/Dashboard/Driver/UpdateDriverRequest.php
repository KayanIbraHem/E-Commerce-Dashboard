...
class UpdateDriverRequest extends FormRequestBase
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['required', 'string', 'email', 'max:255', new UniquePerOrganizationRule($organizationId, 'drivers', __('message.email_column'), $this->driver)],
            'phone' => ['required', 'string', 'max:255', new UniquePerOrganizationRule($organizationId, 'drivers', __('message.phone_column'), $this->driver)],
